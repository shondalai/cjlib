...
// 						    return false;
	...
	function postflight($type, $parent)
	{
		...
		$update_queries[] = 'ALTER TABLE `#__corejoomla_messagequeue` ADD COLUMN `created` DATETIME NOT NULL DEFAULT \'0000-00-00 00:00:00\'';
		$update_queries[] = 'ALTER TABLE `#__corejoomla_messagequeue` ADD COLUMN `processed` DATETIME NOT NULL DEFAULT \'0000-00-00 00:00:00\'';
		$update_queries[] = 'ALTER TABLE `#__corejoomla_messagequeue` ADD INDEX `idx_corejoomla_message_queue_status`(`status`)';
		$update_queries[] = 'ALTER TABLE `#__corejoomla_messagequeue` ADD INDEX `idx_corejoomla_message_queue_created`(`created`)';
		
		$update_queries[] = 'ALTER TABLE `#__corejoomla_countries` ADD COLUMN `id` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT, DROP PRIMARY KEY, ADD PRIMARY KEY (`id`)';
		$update_queries[] = 'ALTER TABLE `#__corejoomla_countries` ADD COLUMN `language` VARCHAR(6) NOT NULL DEFAULT \'*\'';
		$update_queries[] = 'ALTER TABLE `#__corejoomla_countries` ADD UNIQUE INDEX `idx_corejoomla_countries_uniq`(`country_code`, `language`)';
		$update_queries[] = 'ALTER TABLE `#__corejoomla_countries` ADD COLUMN `published` TINYINT(3) NOT NULL DEFAULT \'1\'';
		$update_queries[] = 'ALTER TABLE `#__corejoomla_countries` ADD COLUMN `publish_up` DATETIME NOT NULL DEFAULT \'0000-00-00 00:00:00\'';
		$update_queries[] = 'ALTER TABLE `#__corejoomla_countries` ADD COLUMN `publish_down` DATETIME NOT NULL DEFAULT \'0000-00-00 00:00:00\'';
		$update_queries[] = 'ALTER TABLE `#__corejoomla_messagequeue` ADD COLUMN `retries` INT UNSIGNED NOT NULL DEFAULT \'0\'';
		...
		$update_queries[] = "insert into #__corejoomla_countries(country_name, country_code) values
			...
			('Unknown','XX') ON duplicate key update country_code=values(country_code)";
