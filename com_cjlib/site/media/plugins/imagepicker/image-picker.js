...
(function () {
  ...
  ImagePicker = function () {
    ...
    _createClass(ImagePicker, [{
      ...
      value: function create_picker() {
        this.picker = jQuery("<ul class='image-thumbnails image_picker_selector'></ul>");
        this.picker_options = [];
  ...
  ImagePickerOption = function () {
    ...
    _createClass(ImagePickerOption, [{
      key: "destroy",
      value: function destroy() {
        return this.node.find(".image-thumbnail").off("click", this.clicked);
      }
    }, {
      key: "has_image",
      ...
      value: function mark_as_selected() {
        return this.node.find(".image-thumbnail").addClass("selected");
      }
    }, {
      key: "unmark_as_selected",
      value: function unmark_as_selected() {
        return this.node.find(".image-thumbnail").removeClass("selected");
      }
    }, {
      key: "value",
      ...
      value: function create_node() {
        ...
        thumbnail = jQuery("<div class='image-thumbnail'>");
        // Add custom class
        ...
        if (this.picker.select.data("min-height") != null) {
        	image.css('min-height', this.picker.select.data("min-height"));
        }
        if (this.picker.select.data("max-height") != null) {
        	image.css('max-height', this.picker.select.data("max-height"));
        }
