(function($, window, document, undefined) {
    ...
    Delete.prototype.delete = function() {
        ...
        this.core.$outer.find('.deletePicture').on('click', function() {
        	if (typeof that.core.s.trash == 'function') {
        		that.core.s.trash.call(that).then((value) => {
        			that.trash(that);
        		})
        	} else {
        		that.trash(that);
    ...
    Delete.prototype.trash = function(that) {
    	var elements;
