    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = utf8_encode(strtr(utf8_decode($this->file_dst_name_body), utf8_decode('Ã… Ã…Â½Ã…Â¡Ã…Â¾Ã…Â¸Ãƒâ‚¬ÃƒÂ�Ãƒâ€šÃƒÆ’Ãƒâ€žÃƒâ€¦Ãƒâ€¡ÃƒË†Ãƒâ€°ÃƒÅ Ãƒâ€¹ÃƒÅ’ÃƒÂ�ÃƒÅ½ÃƒÂ�Ãƒâ€˜Ãƒâ€™Ãƒâ€œÃƒâ€�Ãƒâ€¢Ãƒâ€“ÃƒËœÃƒâ„¢ÃƒÅ¡Ãƒâ€ºÃƒÅ“ÃƒÂ�Ãƒ ÃƒÂ¡ÃƒÂ¢ÃƒÂ£ÃƒÂ¤ÃƒÂ¥ÃƒÂ§ÃƒÂ¨ÃƒÂ©ÃƒÂªÃƒÂ«ÃƒÂ¬ÃƒÂ­ÃƒÂ®ÃƒÂ¯ÃƒÂ±ÃƒÂ²ÃƒÂ³ÃƒÂ´ÃƒÂµÃƒÂ¶ÃƒÂ¸ÃƒÂ¹ÃƒÂºÃƒÂ»ÃƒÂ¼ÃƒÂ½ÃƒÂ¿'), 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy'));
                $this->file_dst_name_body = strtr($this->file_dst_name_body, array('ÃƒÅ¾' => 'TH', 'ÃƒÂ¾' => 'th', 'ÃƒÂ�' => 'DH', 'ÃƒÂ°' => 'dh', 'ÃƒÅ¸' => 'ss', 'Ã…â€™' => 'OE', 'Ã…â€œ' => 'oe', 'Ãƒâ€ ' => 'AE', 'ÃƒÂ¦' => 'ae', 'Ã‚Âµ' => 'u'));
            ...
            if ($image_manipulation) {
                ...
                if ($this->processed && $image_src) {
                    ...
                    if ($gd_version >= 2 && $this->image_unsharp && is_numeric($this->image_unsharp_amount) && is_numeric($this->image_unsharp_radius) && is_numeric($this->image_unsharp_threshold)) {
                        ...
                        // Unsharp mask algorithm by Torstein HÃƒÂ¸nsi 2003-07. 
