...
$link = JRoute::_('index.php?option=com_cjlib&task=process&secret=YOURSECRETKEY', false, -1);
    		...
    		<div class="<?php echo $rowClass;?>">
    			<div class="span8 col-md-8">
    				<div class="panel panel-default card">
    					<div class="panel-heading card-header">
    						<div class="panel-title card-title"><?php echo JText::_('COM_CJLIB_ACTIVATE_YOUR_LICENSE');?></div>
    					</div>
    						...
    						<form name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option=com_cjlib&task=save_config');?>" method="post">
    							<div class="<?php echo $rowClass;?> mb-4">
    								<div class="span3 col-md-3">
    									<?php echo JText::_('COM_CJLIB_LICENSE_EMAIL');?>
    								</div>
    								<div class="span9 col-md-9">
    									<input type="email" name="license_email" class="form-control" placeholder="<?php echo JText::_('COM_CJLIB_LICENSE_EMAIL');?>" value="<?php echo $params->get('license_email');?>">
    								</div>
    							</div>
    							<div class="<?php echo $rowClass;?> mb-4">
    								<div class="span3 col-md-3">
    									<?php echo JText::_('COM_CJLIB_LICENSE_KEY');?>
    								</div>
    								<div class="span9 col-md-9">
    									<input type="text" name="license_key" class="form-control" placeholder="<?php echo JText::_('COM_CJLIB_LICENSE_KEY');?>" value="<?php echo $params->get('license_key');?>">
    								</div>
    							</div>
    							
    							<?php if(!empty($params->get('license_key'))):?>
    							<div class="alert alert-info"><i class="fa fa-check-circle"></i> <?php echo JText::_('COM_CJLIB_LICENSE_ACTIVATED');?></div>
    							<button type="submit" class="btn btn-danger">
    								<?php echo JText::_('COM_CJLIB_DEACTIVATE_LICENSE');?>
    							</button>
    							<?php else:?>
    			...
    			<div class="span4 col-md-4">
    				<div class="panel panel-default card mb-3">
    					<div class="panel-heading card-header">
    						<div class="panel-title card-title"><?php echo JText::_('COM_CJLIB');?></div>
    					</div>
    					<div class="panel-body card-body">
    						<?php
    						$component = \JComponentHelper::getComponent('com_cjlib');
    				...
    				<div class="panel panel-default card">
    					<div class="panel-heading card-header">
    						<div class="panel-title card-title"><?php echo JText::_('COM_CJLIB_CRON_URL');?></div>
    					</div>
    					<div class="panel-body card-body">
    						<?php echo $link;?>
    					</div>
