...
class PHPConsoleHandler extends AbstractProcessingHandler
{
	...
	private array $options
        ...
        'dataStorage' => null,
			// \PhpConsole\Storage|null Fixes problem with custom $_SESSION handler (see https://github.com/barbushin/php-console#troubleshooting-with-_session-handler-overridden-in-some-frameworks)
    ];
