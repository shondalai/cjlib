...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     */
	public function addRecord( int|Level $level, string $message, array $context = [], JsonSerializableDateTimeImmutable|null $datetime = null,
	): bool {
	...
	public static function toMonologLevel( string|int|Level $level ): Level {
		...
		if ( $levelEnum === null )
		{
			throw new InvalidArgumentException( 'Level "' . var_export( $level, true ) . '" is not defined, use one of: ' . implode( ', ',
					Level::NAMES + Level::VALUES ) );
		}
