...
class SignalHandler
{
	...
	public function registerSignalHandler(
		int $signo, int|string|Level $level = LogLevel::CRITICAL, bool $callPrevious = true, bool $restartSyscalls = true,
		?bool $async = true): self {
    ...
    public function handleSignal(int $signo, $siginfo = null): void {
        ...
        {
	        if ( \extension_loaded( 'pcntl' ) && \function_exists( 'pcntl_signal' ) && \function_exists( 'pcntl_sigprocmask' )
