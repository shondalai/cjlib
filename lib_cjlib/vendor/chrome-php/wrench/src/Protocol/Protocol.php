...
abstract class Protocol
{
    ...
    public function validateResponseHandshake(string $response, string $key): bool
    {
	    ...
	    if ( self::HTTP_SWITCHING_PROTOCOLS !== $statusCode )
	    {
		    ...
		    throw new HandshakeException( \trim( \sprintf( 'Expected handshake response status code %d, but received %d. %s',
			    self::HTTP_SWITCHING_PROTOCOLS, $statusCode, $errorMessage ) ) );
        }
