...
final class XPathSelector implements Selector
{
    ...
    {
	    return 'document.evaluate(' . \json_encode( $this->expression, \JSON_THROW_ON_ERROR | \JSON_UNESCAPED_SLASHES | \JSON_UNESCAPED_UNICODE )
    ...
    {
	    return 'document.evaluate(' . \json_encode( $this->expression . "[{$position}]",
